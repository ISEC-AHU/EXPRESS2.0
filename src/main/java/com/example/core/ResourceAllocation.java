            ...
            switch (objective) {
                ...
                case "energyInTime":      // energy consumption under deadline constrain
                    if (environmentFlag == 0) {
                        ...
                        if (route == null) {
                            System.out.println("All service allocation plan cannot satisfy the deadline constraint, please modify the order deadline constraint.");
                            return null;
                        }
                    } else {
